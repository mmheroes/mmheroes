...
pub(in crate::ui) fn display_what_to_do<R: Renderer>(
    r: &mut R,
...
pub(in crate::ui) fn display_about_screen<R: Renderer>(
    r: &mut R,
) -> Result<Action, R::Error> {
...
pub(in crate::ui) fn display_where_to_go_and_why<R: Renderer>(
    r: &mut R,
) -> Result<Action, R::Error> {
...
pub(in crate::ui) fn display_about_professors<R: Renderer>(
    r: &mut R,
) -> Result<Action, R::Error> {
...
pub(in crate::ui) fn display_about_characters<R: Renderer>(
    r: &mut R,
) -> Result<Action, R::Error> {
...
pub(in crate::ui) fn display_about_this_program<R: Renderer>(
    r: &mut R,
) -> Result<Action, R::Error> {
...
fn help_dialog<R: Renderer>(r: &mut R) -> Result<Action, R::Error> {
