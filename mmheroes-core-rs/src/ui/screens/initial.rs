...
pub(in crate::ui) fn display_intro<R: Renderer>(r: &mut R) -> Result<Action, R::Error> {
...
pub(in crate::ui) fn display_initial_parameters<R: Renderer>(
    r: &mut R,
    mode: GameMode,
...
pub(in crate::ui) fn display_ding<R: Renderer>(r: &mut R) -> Result<Action, R::Error> {
