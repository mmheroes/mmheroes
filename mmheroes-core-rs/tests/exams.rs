...
fn algebra_pdmi_with_intro() {
    ...
    // Экзамен по алгебре в 9:00, сразу едем в ПОМИ
    // (по пути нас высаживают контролёры)
    replay_game(game_ui, "5↓4r");
    assert_ui!(
        game_ui,
        "
...
Бросить это дело                                 МатАн   ПУНК  9-11     0/10
                                                 ГиТ     ----           0/3
                                                 Инф     ----           0/2
                                                 ИнЯз    ----           0/3
                                                 Физ-ра  ----           0/1
...
fn geometry_pdmi_with_intro() {
    ...
    // Экзамен по геометрии в 15:00, отдыхаем до этого момента и едем в ПОМИ
    // (по пути нас высаживают контролёры)
...
У тебя еще ничего не зачтено.
Сейчас тебя истязает Подкорытов С.С..
Кроме тебя, здесь еще сидят Паша, Diamond и Серж.


Мучаться дальше▁                                 АиТЧ    ----           0/12
Паша                                             МатАн   ----           0/10
Diamond                                          ГиТ     ПОМИ  15-18    0/3
Серж                                             Инф     ----           0/2
Бросить это дело                                 ИнЯз    ----           0/3
