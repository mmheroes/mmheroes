...
fn cafe_pdmi() {
    ...
    // Отдыхаем, забираем деньги у Паши, едем в ПОМИ и заходим в кафе
    replay_game(game_ui, "2↓r2↓r4↓r7↓2r3↓r↓2r2↓r");
    assert_ui!(
        game_ui,
        "
Сегодня 22е мая; 11:00   Версия gamma3.14   Алгебра и Т.Ч.        2   Плохо
...
Кофе за 2 р.▁                                    АиТЧ    ПУНК  13-15    0/12
Корж за 4 р.                                     МатАн   ----           0/10
Кофе и выпечку, 6 р.                             ГиТ     ----           0/3
Ничего, просто просидеть здесь часок.            Инф     ----           0/2
Совсем ничего. Бывает.                           ИнЯз    ПУНК  14-16    0/3
                                                 Физ-ра  ----           0/1
"
    );
...
Финансы: 34 руб.                            Геометрия и Топология 3   Плохо
Голова свежая (5)                           Информатика           0   Плохо
Немного устал (4)                           English               4   Плохо
У тебя много друзей (5)                     Физ-ра                0   Плохо
...
Финансы: 28 руб.                            Геометрия и Топология 3   Плохо
Голова свежая (5)                           Информатика           0   Плохо
Немного устал (4)                           English               4   Плохо
У тебя много друзей (5)                     Физ-ра                0   Плохо
