...
fn no_point_to_go_to_pdmi() {
    ...
    // Отказываемся от приглашения соседа и отдыхаем до 22:00
    replay_game(game_ui, "↓2r2↓r2↓r");
...
"
    ...
    assert_ui!(
        game_ui,
        "
Сегодня 22е мая; 22:00   Версия gamma3.14   Алгебра и Т.Ч.        2   Плохо
...
Самочувствие: отличное (163)                Мат. Анализ           0   Плохо
Финансы: Надо получить деньги за май...     Геометрия и Топология 3   Плохо
Голова свежая (5)                           Информатика           0   Плохо
Немного устал (4)                           English               4   Плохо
У тебя много друзей (5)                     Физ-ра                0   Плохо
...
"
    ...
    assert_ui!(
        ...
        "
Сегодня 22е мая; 19:00   Версия gamma3.14   Алгебра и Т.Ч.        2   Плохо
Самочувствие: отличное (158)                Мат. Анализ           0   Плохо
Финансы: Надо получить деньги за май...     Геометрия и Топология 3   Плохо
Голова свежая (5)                           Информатика           0   Плохо
Немного устал (4)                           English               4   Плохо
У тебя много друзей (5)                     Физ-ра                0   Плохо
...
Голова свежая (5)                           Информатика           0   Плохо
Немного устал (4)                           English               4   Плохо
Ты нормально относишься к окружающим (4)    Физ-ра                0   Плохо
...
fn last_train() {
    ...
    // Отдыхаем до 20:00 и едем в ПОМИ
    replay_game(game_ui, "2↓r2↓r2↓r2↓r2↓r2↓r2↓r2↓r2↓r2↓r2↓r2↓r↓2r5↓2r");

    // Отдыхаем в кафе до полуночи
    replay_game(game_ui, "2↓2r2↓r");
    assert_ui!(
        game_ui,
        "
Сегодня 22е мая; 23:00   Версия gamma3.14   Алгебра и Т.Ч.        2   Плохо
Самочувствие: отличное (169)                Мат. Анализ           0   Плохо
Финансы: Надо получить деньги за май...     Геометрия и Топология 3   Плохо
Голова свежая (5)                           Информатика           0   Плохо
Немного устал (4)                           English               4   Плохо
Тебе непросто общаться с людьми (3)         Физ-ра                0   Плохо
...
Ничего, просто просидеть здесь часок.▁           АиТЧ    ПУНК  13-15    0/12
Совсем ничего. Бывает.                           МатАн   ----           0/10
                                                 ГиТ     ----           0/3
                                                 Инф     ----           0/2
                                                 ИнЯз    ПУНК  14-16    0/3
                                                 Физ-ра  ----           0/1
"
    ...
    assert_ui!(
        game_ui,
        "
Ты глядишь на часы и видишь: уже полночь!
На последней электричке ты едешь домой, в общагу.
