...
ЧТО ДЕЛАТЬ ???
    ...
    assert_ui!(
        ...
        "
                        22.5   23.5   24.5   25.5   26.5   27.5
Всемирнов М.А.                        ПУНК          ПУНК   ПУНК       Осталось
Алгебра и Т.Ч.                        10-12         12-14  10-14      12 заданий

Дубцов Е.С.             ПУНК   ПУНК   ПУНК   ПУНК   ПУНК   ПУНК       Осталось
Мат. Анализ             13-15  13-15  14-16  10-12  15-18  13-16      10 заданий

Подкорытов С.С.         ПОМИ   ПОМИ                        ПУНК       Осталось
Геометрия и Топология   12-15  11-12                       13-15      3 задания

Климов А.А.                           Компы  Компы                    Осталось
Информатика                           15-17  14-15                    2 задания

Влащенко Н.П.                  ПУНК                        ПУНК       Осталось
English                        15-17                       11-13      3 задания
